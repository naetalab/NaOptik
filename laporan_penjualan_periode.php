...
<table class="table table-striped table-bordered table-condensed">
  <tr>
    ...
    <td width="276" bgcolor="#CCCCCC"><strong>No. Penjualan </strong></td>
   
    <td colspan="2" align="center" bgcolor="#CCCCCC"><strong>Tools</strong></td>
  </tr>
  <?php
	# Perintah untuk menampilkan Penjualan dengan Filter Periode
	$mySql = "SELECT * FROM penjualan $filterSQL ORDER BY kd_jual DESC LIMIT $halaman, $barisData";
  ...
  <tr>
    ...
    <td width="42" align="center"><a href="penjualan/penjualan_cetak.php?noNota=<?php echo $noNota; ?>" target="_blank">Cetak</a></td>
    <td width="33" align="center"><a href="penjualan/penjualan_nota.php?noNota=<?php echo $noNota; ?>" target="_blank">Nota</a></td>
  </tr>
  <?php } ?>
